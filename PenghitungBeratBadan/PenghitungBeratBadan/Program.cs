...
namespace PenghitungBeratBadan
{
    internal class Program
    {
        ...
        {
            BeratPerempuan beratPerempuan = new BeratPerempuan();
            // beratPerempuan adalah object
            BeratPerempuanBuilder beratPerempuanBuilder = new BeratPerempuanBuilder(beratPerempuan);
            ...
            beratPerempuanBuilder.setBeratTinggiPerempuan(berat, tinggi);
            beratPerempuanBuilder.printBeratTinggiPerempuan();
        }
    }
}
